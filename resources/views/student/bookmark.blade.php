                                    ...
                                    <div class="mc_content_list">
                                            ...
                                            <div class="overlay">
                                                <ul class="mb0">
                                                   {{--  <li class="list-inline-item">
                                                    ...
                                                    <li class="list-inline-item">
                                                        <a class="mcc_view" href="{{url('/class/'.$c->course->slug)}}">View</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="details">
                                            <div class="mc_content">
                                                <p class="subtitle"><a href="{{url('profile/'.$t->user->name.'/'.$t->teacher_id)}}">{{$t->user->name}}</a></p>
                                                <h5 class="title"><a href="{{url('/class/'.$c->slug)}}">{{$c->course->title}}</a></h5>
                                            ...
                                            <div class="mc_footer">
                                                <div class="lft-section">
                                                    <ul class="mc_meta fn-414">
                                                        ...
                                                        <li class="list-inline-item"><a href="#">{{studentEnrolled($c->course->id)}}</a></li>
                                                    </ul>
