    ...
    var S,
        ...
        N = {
                ...
                this.built || this.build(),
                    this.shown ||
                        ...
                        this.inline ||
                            ...
                            k(document).on(r, (this.onGlobalClick = M(this.globalClick, this))),
                            k(document).on(c, (this.onGlobalKeyup = M(this.globalKeyup, this))),
                            i && k(document).on(f, (this.onTouchStart = M(this.touchstart, this))),
                            this.place()));
            },
            hide: function () {
                this.shown &&
                    (this.trigger(o).isDefaultPrevented() ||
                        ...
                        this.inline || (this.$scrollParent.off(u, this.place), k(window).off(a, this.onResize), k(document).off(r, this.onGlobalClick), k(document).off(c, this.onGlobalKeyup), i && k(document).off(f, this.onTouchStart))));
            },
            toggle: function () {
            ...
            pick: function (t) {
                var e = this.$element,
                    i = this.date;
                this.trigger(d, { view: t || "", date: i }).isDefaultPrevented() || ((i = this.formatDate(this.date)), this.setValue(i), this.isInput && (e.trigger("input"), e.trigger("change")));
            },
            reset: function () {
            ...
            formatDate: function (t) {
                ...
                return (
                    F(t) &&
                        ...
                        (i = t.getMonth()),
                        (t = t.getDate()),
                        (a = { d: t, dd: I(t, 2), m: i + 1, mm: I(i + 1, 2), yy: String(e).substring(2), yyyy: I(e, 4) }),
                        (n = s.source),
                    ...
                    switch (r) {
                        ...
                        case "year":
                            (h = parseInt(e.text(), 10)),
                                ...
                                s.setDate(V(h, o, t)),
                                s.setFullYear(h),
                                n.hasMonth ? this.showView(v) : (e.addClass(i.pickedClass).data("view", "year picked").siblings(".".concat(i.pickedClass)).removeClass(i.pickedClass).data("view", "year"), this.hideView()),
                                this.pick("year");
                            break;
                        case "month prev":
                        case "month next":
                        ...
                        case "month":
                            (o = k.inArray(e.text(), i.monthsShort)),
                                ...
                                s.setDate(V(h, o, t)),
                                s.setMonth(o),
                                n.hasDay ? this.showView(m) : (e.addClass(i.pickedClass).data("view", "month picked").siblings(".".concat(i.pickedClass)).removeClass(i.pickedClass).data("view", "month"), this.hideView()),
                                this.pick("month");
                            break;
                        case "day prev":
                        case "day next":
        ...
        q = {
            ...
            renderYears: function () {
                for (
                    ...
                    o.push(this.createItem({ picked: f, disabled: p, text: n + d, view: p ? "year disabled" : g, highlighted: u.getFullYear() === r }));
                }
            ...
            renderMonths: function () {
                for (
                    ...
                    var y = new Date(h, g, 1),
                        m = !1;
                    e && (m = (p = y.getFullYear() === e.getFullYear()) && y.getMonth() < e.getMonth()),
                        !m && i && (m = (f = y.getFullYear() === i.getFullYear()) && y.getMonth() > i.getMonth()),
                        !m && r && (m = !1 === r.call(this.$element, y, "month"));
                    var v = h === c && g === d,
                        w = v ? "month picked" : "month";
                    u.push(this.createItem({ disabled: m, picked: v, highlighted: h === o && y.getMonth() === l, index: g, text: n[g], view: m ? "month disabled" : w }));
                }
            ...
            renderDays: function () {
                ...
                for ((C = r.getDay() - (parseInt(c, 10) % 7)) <= 0 && (C += 7), a && (n = r.getTime() <= a.getTime()), P = t - (C - 1); P <= t; P += 1) {
                    ...
                    a && (x = $.getTime() < a.getTime()),
                        ...
                        k.push(this.createItem({ disabled: x, highlighted: D === f && b === g && $.getDate() === y, muted: !0, picked: D === m && b === v && P === w, text: P, view: "day prev" }));
                }
                var F = [],
                    M = u,
                    Y = p,
                ...
                for (s && (c = r.getTime() >= s.getTime()), P = 1; P <= C; P += 1) {
                    ...
                    s && (I = V.getTime() > s.getTime()),
                        ...
                        F.push(this.createItem({ disabled: I, picked: T, highlighted: M === f && Y === g && V.getDate() === y, muted: !0, text: P, view: "day next" }));
                }
                for (var S = [], P = 1; P <= t; P += 1) {
                    ...
                    var q = u === m && p === v && P === w,
                        A = q ? "day picked" : "day";
                    S.push(this.createItem({ disabled: j, picked: q, highlighted: u === f && p === g && N.getDate() === y, text: P, view: j ? "day disabled" : A }));
                }
                this.$monthPrev.toggleClass(h, n),
                    this.$monthNext.toggleClass(h, c),
                    this.$monthCurrent.toggleClass(h, n && c).html(i.yearFirst ? "".concat(u + d, " ").concat(l[p]) : "".concat(l[p], " ").concat(u).concat(d)),
        ...
        J = (function () {
            function i(t) {
                ...
                !(function (t, e) {
                    ...
                    (this.$element = k(t)),
                    (this.element = t),
                    (this.options = k.extend({}, n, y[e.language], k.isPlainObject(e) && e)),
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            this.built ||
                                ...
                                this.inline ? k(e.container || t).append(i.addClass("".concat(l, "-inline"))) : (k(document.body).append(i.addClass("".concat(l, "-dropdown"))), i.addClass(g).css({ zIndex: parseInt(e.zIndex, 10) })),
                                this.renderWeek());
                        },
                    },
                    {
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            k.isFunction(t.show) && e.on(p, t.show),
                                ...
                                this.inline || (t.trigger ? this.$trigger.on(r, k.proxy(this.toggle, this)) : this.isInput ? e.on(h, k.proxy(this.show, this)) : e.on(r, k.proxy(this.show, this)));
                        },
                    },
                    {
                        key: "unbind",
                        value: function () {
                            ...
                            k.isFunction(e.show) && t.off(p, e.show),
                                ...
                                this.inline || (e.trigger ? this.$trigger.off(r, this.toggle) : this.isInput ? t.off(h, this.show) : t.off(r, this.show));
                        },
                    },
                    {
                        key: "showView",
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            return (
                                ...
                                "<".concat(i, ' class="').concat(s.join(" "), '" data-view="').concat(a.view, '">').concat(a.text, "</").concat(i, ">")
                            );
                        },
                    },
                    {
