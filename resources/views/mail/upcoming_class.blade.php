                            ...
                            <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                                <tr>
                                    <td style="padding:0 0 20px 0;color:#000000; text-align: center;">
                                        <h1 style="font-size:24px;margin: 0;line-height: 1;font-family: 'Montserrat', sans-serif!important;font-weight: 500;">Class Reminder!</h1>
                                        <h2 style="font-size:18px;margin:20px 0 20px 0;font-family: 'Montserrat', sans-serif!important;font-weight: 500;">You have an upcoming class today.</h2>                                        
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="padding:0;">
                                        <table role="presentation" style="width: 56%;margin: auto;border-collapse:collapse;border:0;border-spacing:0;border: 2px solid #eeeeee;">
                                            ...
                                            <tr>
                                                    ...
                                                    <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                                                        <tr>
                                                            <td style="padding:0;width:50%;" align="center">
                                                                <a href="{{$details['url']}}" style="color:#ffffff; background:#18056b; padding: 9px 15px; text-align: center; font-size: 14px; text-decoration: none; font-weight: 500;font-family:'montserrat' , sans-serif!important;">{{$details['btn']}}</a>
                                                ...
                                                @else
                                                 <td style="padding:20px 0 20px 0;color:#000000; text-align: center;align-items:center;">
                                ...
                                @if($details['desc'])
                                <tr>
                                    <td style="padding:0 0 20px 0;color:#000000; text-align: left;">
                                        <p style="margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:'montserrat' , sans-serif!important;padding: 31px 0px 0 0px; font-weight: 600;">Class Description</p>
                                        <p style="margin:0 0 12px 0;font-size:14px;line-height:24px;font-family:'montserrat' , sans-serif!important;padding: 0; font-weight: 500;">{!! substr($details['desc'],0,200) !!}</p>                                        
                                    </td>
                                </tr>
                                @endif
                                <tr>
                                    <td style=" padding: 0;" colspan="2">
                                        <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                                            <tr>
                                                ...
                                                <td style="padding:0;width:50%; text-align: @if($details['desc']) left @else center @endif;" >
