                                ...
                                @if(count($courses) > 0 )
                                    ...
                                    <div class="custom_my_course_content_list_inner">
                                            ...
                                            <div class="mc_content_list">
                                                ...
                                                <div class="details">
                                                    <div class="mc_content">
                                                        <p class="subtitle"><span>{{$c->user->name}}</span></p>
                                        ...
                                        <form action="{{url('teacher/cancel-course')}}" method="post" class="d-inline"> @csrf @method('post')
                                                                        ...
                                                                        @else
                                        <a href="#!" class="btn btn-primary-custom btn-primary-custom-round btn-primary-custom-border" data-toggle="modal" data-target="#cancle_calss-{{$c->id}}">Cancel</a> 
                                        @endif
                                        @else
                                          <a href="{{url('/teacher/reschedule-course/'.$c->slug)}}" class="btn btn-primary-custom btn-primary-custom-round btn-primary-custom-border" >Reschedule</a>

                                        @endif
                                             <div class="modal cancel-class-modal" id="cancle_calss-{{$c->id}}" tabindex="-1" role="dialog" aria-hidden="true" course={{$c->id}}>
                                                            <div class="modal-dialog modal-md modal-dialog-centered" role="document">
                                                                <form action="{{url('teacher/cancel-course')}}" method="post"> 
                                                                    ...
                                                                    <font color="red">10% </font> of the total earnings will be deducted as cancellation penalty. The amount will be deducted from your credit card which is connected to your account. For more information,<a href="{{url('/term-and-conditions')}}" class="text-primary"> refer</a> to the T&C.This is not applicable if there are no enrolled students.<br><br>

                                                                    <h4>Cancellation within 24 hours of scheduled class:</h4><hr>
                                                                    <font color="red">15% </font> of the total earnings will be deducted as cancellation penalty. The amount will be deducted from your credit card which is connected to your account. For more information, <a href="{{url('//term-and-conditions')}}" class="text-primary">refer</a> to the T&C.This is not applicable if there are no enrolled students.
                                                                    For more information, refer to<a href="{{url('/cancellation-policy')}}" class="text-primary"> refund and cancellation policy</a>
                                                                    </p>
