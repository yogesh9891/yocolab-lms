                            ...
                            <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                                                    ...
                                                    <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                                                        <tr>
                                                            <td style="padding:0;width:50%;" align="center">
                                                                <a href="{{$details['url']}}" style="color:#ffffff; background:#18056b; padding: 9px 15px; text-align: center; font-size: 14px; text-decoration: none; font-weight: 500;font-family:'montserrat' , sans-serif!important;">Join Now</a>
                                ...
                                <tr>
                                    <td style="padding:0 0 20px 0;color:#000000; text-align: left;">
                                        ...
                                        <p style="margin:0 0 12px 0;font-size:14px;line-height:24px;font-family:'montserrat' , sans-serif!important;padding: 0; font-weight: 500;">{!! $details['desc'] !!}</p>                                        
                                    </td>
                                </tr>
                                @endif
                                <tr>
