...
<body style="margin:0;padding:0;">
    <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;background:#ffffff;">
        <tr>
            <td align="center" style="padding:0;">
                <table role="presentation" style="width:607px;border-collapse:collapse;border-spacing:0;text-align:left;">
                    ...
                    <tr>
                        ...
                        <td style="padding: 0 20px 0 0;width:50%;" align="right">
                            <p style="display: inline-block; text-transform: uppercase; color: #000000; font-size: 25px; font-weight: 400;font-family:'montserrat' , sans-serif!important;text-align: center;line-height: 31px;">FULL REFUND <br>Instructor Cancellation</p>
                        </td>
                    </tr>
                        ...
                        <td style="padding:36px 30px 42px 30px; width: 100%;" colspan="2">
                            <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                       <p style="margin-bottom: 0; color: #7e7e7e;font-size: 14px; font-weight: 400;">0.0</p> 
                                    </td>
                                    <td style="text-align: center;">
                                       <p style="margin-bottom: 0; color: #7e7e7e;font-size: 14px; font-weight: 400;">{{$details['price']}}</p> 
                                    </td>
                            ...
                            <table role="presentation" style="border-collapse:collapse;border-spacing:0;width: 90%;margin: auto;border-top: 2px solid #7e7e7e;border-bottom: 2px solid #7e7e7e;">
                                ...
                                <tr>
                                    <td style="padding-top: 15px; width: 78%;">
                                       <p style="margin-bottom: 0; margin-top: 0; color: #7e7e7e;font-size: 12px; font-weight: 400;">Refund Amount</p> 
                                    </td>
                                    <td style="padding-top: 15px; width:50%;">
                                       <p style="margin-bottom: 0; margin-top: 0; color: #7e7e7e;font-size: 12px; font-weight: 400;">{{$details['price']}}</p> 
                                    </td>
                                    
                                </tr>
                                <tr>
                                    <td style="padding: 0; width: 78%;">
                                       <p style="margin-bottom: 0; margin-top: 0; color: #7e7e7e;font-size: 12px; font-weight: 400;">+ 6% Processing Fee during class purchase</p> 
                                    </td>
                                    <td style="padding: 0; width:50%;">
                                       <p style="margin-bottom: 0; margin-top: 0; color: #7e7e7e;font-size: 12px; font-weight: 400;">{{$details['fee']}}</p> 
                                    </td>
                                ...
                                <tr>
                                    <td style="padding-bottom: 10px; width: 78%;">
                                       <p style="margin-bottom: 0; margin-top: 10px; color: #7e7e7e;font-size: 15px; font-weight: 400;">Total Refund</p> 
                                    </td>
                                    <td style="padding-bottom: 10px; width:50%;">
                                       <p style="margin-bottom: 0; margin-top: 10px; color: #fd6100;font-size: 20px; font-weight: 400;">{{$details['charge']}}</p> 
                                    </td>
                            ...
                            <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                                ...
                                <tr>
                                    <td style="padding:0px 0 0 30px;color:#7e7e7e; text-align: left;">
                                        <p style="font-size:11px;line-height: 1.6;font-family: 'Montserrat', sans-serif!important;font-weight: 400; margin-bottom: 0; margin-top: 0;">Refer to Yocolab T&C for Yocolab cancellation policy for any questions</p>                                       
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding:0px 0 0 30px;color:#7e7e7e; text-align: left;">
