			...
			<div class="row" id="formTop">
				...
				<div class="col-xl-6 offset-xl-3 text-center">
					<div class="breadcrumb_content">
						<h4 class="breadcrumb_title">Reschedule Class</h4>
						<ol class="breadcrumb">
						    <li class="breadcrumb-item"><a href="{{url('/')}}">Home</a></li>
						    <li class="breadcrumb-item active" aria-current="page">Reschedule Class</li>
						</ol>
					</div>
				</div>
			</div>
                   ...
                   @endif
		            <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
		          		<div class="form-header-block">
			                ...
			                <h2 ><strong >Reschedule Class</strong></h2>
			                {{-- <input type="text" class="multi-heading"> --}}
			                <p>Fill your form and click next
		          		</div>
		                <div class="row">
		                    <div class="col-md-12 mx-0">
		                        <form id="msform" action="{{route('resheduleSubmitCourse')}}" enctype="multipart/form-data"    method="post">
		                        @csrf
		                        @method('post')
		                            <!-- progressbar -->
</p>					<input type="hidden" name="slug" value="{{$course->slug}}">
		                            <ul id="progressbar">
		                            	...
		                            	<div class="form-card">
		                            		...
		                            		<div class="radio-wrapper mb-3 bdr-b" >
			                            		...
			                            		<div class="radio mr-5">
													...
													<input id="radio_one" name="paid" type="radio" class="form-control" value="free"  @if($course->price ==null) checked=""  @endif >
												...
												<div class="radio mr-5">
													@if($teacher->account_id !=null && $teacher_card !="")
														<input id="radio_two"  type="radio" class="form-control" value="paid"   name="paid"   @if($course->price !=null) checked=""  @endif >
													@else
													<input id="radio_two"  type="radio" class="form-control"  disabled="true" title="Please Add Bank/Card details"  >
													@endif
												...
												{{-- 	<input id="radio_two" name="paid" type="radio" class="form-control" value="paid" >
													...
													<span class="payment-type-btn-holder">
														@if($teacher->account_id ==null)	<a href="{{url('teacher/bank-details')}}" class="btn btn-primary-custom btn-primary-custom-round btn-primary-custom-border">Add Bank Details</a>
							                            @endif
		                            ...
		                            <fieldset id="formTop">
		                                <div class="form-card">
		                                    <div class="form-group">
		                            			...
		                            			<textarea class="form-control" id="course_description" name="decription" rows="5" placeholder="Class Description">{{strip_tags($course->desciption)}}</textarea>
		                            		</div>
		                            		<div class="form-group">
		                            ...
		                            <fieldset  id="formTop">
		                                <div class="form-card " id="resPrice" >
		                                	<div  id="hidePrice" class="row">
		                                		...
		                                		@endphp 
		                                		<input type="text" name="currency" value="{{strtoupper($t->currency)}}" readonly="true"  class="form-control h50" >
		                            	{{-- 	<div class="ui_kit_select_search">
		                                    ...
		                                    <div class="form-group col-md-4 mt-4">
		                            			...
		                            			<input type="number" class="form-control h50" id="price" name="price" placeholder="$0" min="{{round($t->min_price)}}" value="{{$course->price}}" >
		                            		</div>
		                                    <div class="form-group mt-4 percentage-icon col-md-4">
		                            			<label>Discount</label>
		                            			<input type="number" class="form-control h50" id="discount" name="discount" placeholder="e.g. 35" min="0" max="99" value="{{$course->discount}}">
		                            		</div>
		                            ...
		                            <fieldset id="formTop">
		                            	<div class="form-card">
		                            		...
		                            		<div class="form-row mt-3 align-items-center">
			                            		<div class="form-group col-md-5 file-upload-block">
											        ...
											        <input type="text" class="form-control h50" id="video_url" name="video_url" placeholder="Add Video URL" name="preview_url" size="10" value="{{$course->url}}"> >
			                            		</div>
		                            	...
		                            	<input type="button" name="previous" class="previous btn btn-primary-custom btn-primary-custom-round" value="Previous" style="width: auto;color: #fff;padding: 15px 35px;" />
										<input type="submit" name="next" class="btn btn-primary-custom btn-primary-custom-round" id="formSubmitBtn" value="Submit" style="width: auto;color: #fff;padding: 15px 35px;" id="step5"/>
		                            </fieldset>
		                        </form>
		                    </div>
		                </div>
...
duration = $(this).parent().find('input[name="duration"]').val();
