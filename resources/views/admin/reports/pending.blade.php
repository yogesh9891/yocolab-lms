                    ...
                    @endif
                        <div class="col-lg-12">
                            ...
                            <nav class="breadcrumb_widgets" aria-label="breadcrumb mb30">
                                <h4 class="title float-left">RazorPay Pending Reports</h4>  
                                <a href="{{url('admin/payment-complete')}}" class="btn btn-danger float-right">Pay Now</a>
                                <button   class="btn btn-info float-right">{{pendingAmount()}} INR</button>
                            </nav>
